...
const Content = (props) => {  
  return (
    <>
      <Part part={props.partMain.parts[0].name} exer={props.partMain.parts[1].exercises}/>
      <Part part={props.partMain.parts[1].name} exer={props.partMain.parts[0].exercises}/>
